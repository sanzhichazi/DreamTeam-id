...
const defaultComponents: RichTextProps["components"] = {
  ...
  thead: ({ children }) => <thead className="text-left text-[#60646C] font-medium text-xs uppercase">{children}</thead>,
  th: ({ children }) => <th className="px-3 py-2 border-b border-[#E8E8EC]">{children}</th>,
  td: ({ children }) => <td className="px-3 py-2 border-b border-[#E8E8EC]">{children}</td>,
  tr: ({ children }) => <tr className="border-b border-[#E8E8EC]">{children}</tr>,
